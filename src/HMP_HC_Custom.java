...
public class HMP_HC_Custom {
     ...
     * 构造函数
     */
    public HMP_HC_Custom(int maxIterations, double improvementThreshold, int maxCodeTableSize) {
        ...
        try {
            ...
            while (codetable.size() < maxCodeTableSize / 3) {
                ...
                while (iterations < maxIterations) {
                    ...
                    iterations++;
                    iterationTryCount++;
                    if (iterationTryCount > 20) {
                        // 如果模式找不到好的邻居，我们应该移动到下一个模式
                        break;
                    }
                }
            ...
            result.put("compressionRatio", improveCompressionSize / initialCompressionSize * 100);
    ...
    // 以下方法与原HMP_HC_Runner基本相同，为了可读性进行了简化
