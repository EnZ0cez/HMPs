...
public class HMP_HC_Runner_Classification {

    // Constants for the simulated annealing algorithm
    static final int MAX_ITERATIONS = 40;
    ...
    static int max_code_table_size = 63;

    public static void main(String[] args) throws IOException {
        // Specify the single file to process
        String filePath = "Datasets/wine.txt"; // Replace with different actual file path
        ...
        if (file.exists() && file.isFile()) {
            ...
            String outputFile = "result_HMP_HC_" + baseName  + ".txt"; // e.g., "result_SA_Com_yourfile.txt"
